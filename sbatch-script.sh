...
# 1x2x24x3 = 144
TASKS=$(python -c "import itertools;genomes='hg38'.split();proteins='E2F1 E2F4'.split();chroms='chr1 chr2 chr3 chr4 chr5 chr6 chr7 chr8 chr9 chr10 chr11 chr12 chr13 chr14 chr15 chr16 chr17 chr18 chr19 chr20 chr21 chr22 chrX chrY'.split();cores='CCGC GCGC GCGG'.split();print ' '.join(['_'.join(x) for x in list(itertools.product(genomes, proteins, chroms, cores))])")
TASKS_ARRAY=(${TASKS// / })
